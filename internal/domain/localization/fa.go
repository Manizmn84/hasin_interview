...
var Persian = map[string]interface{}{
	...
	"redis":                "ردیس",
	"licensePlate":         "پلاک ماشین",
	"registrationCard":     "کارت ماشین",
	"vehicle":              "ماشین",
	"carModel":             "مدل ماشین",
	"registrationCardSize": "سایز عکس کارت ماشین",
	...
	"errors": map[string]interface{}{
		...
		"lte":                    "عدد باید کوچکتر باشد.",
		"gt":                     "عدد باید بزگتر باشد.",
		"ir_phone":               "این {0} معتبر نمی باشد",
		"ir_postal":              "این {0} معتبر نمی باشد",
		"duplicate":              "این {0} تکراری می باشد",
		"conflict":               "این {0} تداخل دارد.",
		"nationalCodeLength":     "کد ملی باید دقیقاً ۱۰ رقم باشد.",
		"shabaLength":            "شماره شبا باید دقیقاً ۲۴ رقم باشد.",
		"wrongFormat":            "فرمت {0} اشتباه است.",
		"tooLarge":               "{0} بیش ازاندازه بزرگ است.",
		"empty":                  "{0} نمیتونه خالی باشه.",
		"badRequestError":        "این {0} برای درخواست شکست خورد.",
	},
	"successMessage": map[string]interface{}{
		...
		"deleteParking":             "پارکینگ با موفقیت حذف شد.",
		...
		"addNumber":                 " اعداد با موفقیت جمع شدند.",
		"SendOtp":                   "کد یکبار مصرف با موفقیت ارسال شد.",
		"VerifyOtp":                 "کد یکبار مصرف با موفقیت تایید شد.",
		"updateParking":             "پارکینگ با موفقیت بروزرسانی شد.",
		"createParking":             "پارکینگ با موفقیت ایجاد شد.",
		"detailParking":             "دریافت اطلاعات پارکینگ با موفقیت انجام شد.",
		"getAttributes":             "لیست ویژگی ها با موفقیت دریافت شد.",
		"getCities":                 "لیست شهر ها با موفقیت دریافت شد.",
		"getProfile":                "اطلاعات حساب کاربری با موفقیت دریافت شد.",
		"registerVehicle":           "ماشین با موفقیت ساخته شد.",
		"getVehicle":                "اطلاعات ماشین با موفقیت دریافت شد.",
		"deleteVehicle":             "ماشین با موفقیت حذف شد.",
	...
	"otp": map[string]interface{}{
		"invalid":      " کد ارسال شده برای او تی پی معتبر نمیباشد.",
		"alreadyUsed":  "کد ارسال شده قبلا استفاده شده.",
		"alreadyExist": "کد قبلی هنوز استفاده نشده.",
	},
	"jwt": map[string]interface{}{
		"invalidSignedToken": "امضا توکن اشتباه است.",
		"invalidAuthToken":   "توکتن معتبر نیست.",
		"claimReject":        "ادعا توکن رد شد.",
		"emptyToken":         "توکن خالی است.",
	},
	"auth": map[string]interface{}{
		"emptyHeader":   "هدر خالی است.",
		"invalidHeader": "فرمت هدر معتبر نیست.",
	},
}
